...
export declare const PartialMessages: {
    readonly ja: {
        ...
        "Auto-accept compatible tweak mismatches": string;
        "Automatically accepts mismatches that are compatible but potentially lossy by comparing tweak modification times.": string;
        ...
        "Changing this setting requires migrating existing data (a bit time may be taken) and restarting Obsidian. Please make sure to back up your data before proceeding.": string;
        Check: string;
        ...
        "Effectively a directory. Should end with `/`. e.g., `vault-name/`.": string;
        ...
        "Enable forcePathStyle": string;
        "Enable per-file customization sync": string;
        ...
        "Encryption passphrase. If changed, you should overwrite the server's database with the new (encrypted) files.": string;
        ...
        "End-to-End Encryption Algorithm": string;
        "Endpoint URL": string;
        ...
        "File prefix on the bucket": string;
        ...
        "If enabled, efficient per-file customization sync will be used. A minor migration is required when enabling this feature, and all devices must be updated to v0.23.18. Enabling this feature will result in losing compatibility with older versions.": string;
        ...
        "If enabled, the file properties will be encrypted in the remote database. This is useful for protecting sensitive information in file paths, sizes, and IDs of its chunks. If you are using V1 E2EE, this only obfuscates the file path.": string;
        "If enabled, the file under 1kb will be processed in the UI thread.": string;
        "If enabled, the forcePathStyle option will be used for bucket operations.": string;
        "If enabled, the notification of hidden files change will be suppressed.": string;
        "If enabled, the plugin will not attempt to connect to the remote database even if the chunk was not found locally.": string;
        ...
        "Internal timestamp for resolving compatible tweak mismatches.": string;
        "Interval (sec)": string;
        ...
        "Key ID": string;
        "Keypair or pre-shared key": string;
        lang_def: string;
        "lang-de": string;
        "lang-def": string;
        "lang-es": string;
        ...
        "lang-zh": string;
        "lang-zh-tw": string;
        "Last tweak modified timestamp": string;
        Later: string;
        ...
        "liveSyncReplicator.mismatchedTweakDetected": string;
        ...
        "Now we can choose how to split the chunks; V3 is the most efficient. If you have troubled, please make this Default or Legacy.": string;
        ...
        "obsidianLiveSyncSettingTab.logServerConfigurationCheck": string;
        ...
        "Please use V2, V1 is deprecated and will be removed in the future, It was not a very appropriate algorithm. Only for compatibility V1 is kept.": string;
        ...
        "The Application ID for P2P connection. This should be same among your devices. Default is 'self-hosted-livesync' and could not be modified from the UI.": string;
        "The credential/password for the TURN servers.": string;
        ...
        "The Nostr relay servers to establish connections for P2P connections. Multiple servers can be separated by commas.": string;
        "The Passphrase for P2P connection. This should be same among your devices.": string;
        "The Room ID for P2P connection. This should be same among your devices.": string;
        "The TURN servers to use for P2P connections. Multiple servers can be separated by commas.": string;
        "The username for the TURN servers.": string;
        ...
        "TweakMismatchResolve.Action.DisableAutoAcceptCompatible": string;
        "TweakMismatchResolve.Action.Dismiss": string;
        "TweakMismatchResolve.Action.EnableAutoAcceptCompatible": string;
        ...
        "TweakMismatchResolve.Message.AutoAcceptCompatibleUndefined": string;
        "TweakMismatchResolve.Message.Main": string;
        "TweakMismatchResolve.Message.MainTweakResolving": string;
        "TweakMismatchResolve.Message.mineUpdated": string;
        "TweakMismatchResolve.Message.remoteUpdated": string;
        ...
        "TweakMismatchResolve.Title.AutoAcceptCompatible": string;
        "TweakMismatchResolve.Title.TweakResolving": string;
        "TweakMismatchResolve.Title.UseRemoteConfig": string;
        "Ui.Common.Signal.Caution": string;
        "Ui.Common.Signal.Danger": string;
        "Ui.Common.Signal.Notice": string;
        "Ui.Common.Signal.Warning": string;
        "Ui.Settings.Advanced.LocalDatabaseTweak": string;
        "Ui.Settings.Advanced.MemoryCache": string;
        "Ui.Settings.Advanced.TransferTweak": string;
        "Ui.Settings.Common.Analyse": string;
        "Ui.Settings.Common.Back": string;
        "Ui.Settings.Common.Check": string;
        "Ui.Settings.Common.Configure": string;
        "Ui.Settings.Common.Continue": string;
        "Ui.Settings.Common.Delete": string;
        "Ui.Settings.Common.Fetch": string;
        "Ui.Settings.Common.Lock": string;
        "Ui.Settings.Common.Merge": string;
        "Ui.Settings.Common.Open": string;
        "Ui.Settings.Common.Overwrite": string;
        "Ui.Settings.Common.Perform": string;
        "Ui.Settings.Common.ResetAll": string;
        "Ui.Settings.Common.ResolveAll": string;
        "Ui.Settings.Common.Scan": string;
        "Ui.Settings.Common.Send": string;
        "Ui.Settings.Common.Use": string;
        "Ui.Settings.Common.VerifyAll": string;
        "Ui.Settings.CustomizationSync.OpenDesc": string;
        "Ui.Settings.CustomizationSync.Panel": string;
        "Ui.Settings.CustomizationSync.WarnChangeDeviceName": string;
        "Ui.Settings.CustomizationSync.WarnSetDeviceName": string;
        "Ui.Settings.Hatch.AnalyseDatabaseUsage": string;
        "Ui.Settings.Hatch.AnalyseDatabaseUsageDesc": string;
        "Ui.Settings.Hatch.BackToNonConfigured": string;
        "Ui.Settings.Hatch.ConvertNonObfuscated": string;
        "Ui.Settings.Hatch.ConvertNonObfuscatedDesc": string;
        "Ui.Settings.Hatch.CopyIssueReport": string;
        "Ui.Settings.Hatch.DatabaseLabel": string;
        "Ui.Settings.Hatch.DatabaseToStorage": string;
        "Ui.Settings.Hatch.DeleteCustomizationSyncData": string;
        "Ui.Settings.Hatch.GeneratedReport": string;
        "Ui.Settings.Hatch.Missing": string;
        "Ui.Settings.Hatch.ModifiedSize": string;
        "Ui.Settings.Hatch.ModifiedSizeActual": string;
        "Ui.Settings.Hatch.PrepareIssueReport": string;
        "Ui.Settings.Hatch.RecoveryAndRepair": string;
        "Ui.Settings.Hatch.RecreateAll": string;
        "Ui.Settings.Hatch.RecreateMissingChunks": string;
        "Ui.Settings.Hatch.RecreateMissingChunksDesc": string;
        "Ui.Settings.Hatch.ResetPanel": string;
        "Ui.Settings.Hatch.ResetRemoteUsage": string;
        "Ui.Settings.Hatch.ResetRemoteUsageDesc": string;
        "Ui.Settings.Hatch.ResolveAllConflictedFiles": string;
        "Ui.Settings.Hatch.ResolveAllConflictedFilesDesc": string;
        "Ui.Settings.Hatch.RunDoctor": string;
        "Ui.Settings.Hatch.ScanBrokenFiles": string;
        "Ui.Settings.Hatch.ScramSwitches": string;
        "Ui.Settings.Hatch.ShowHistory": string;
        "Ui.Settings.Hatch.StorageLabel": string;
        "Ui.Settings.Hatch.StorageToDatabase": string;
        "Ui.Settings.Hatch.VerifyAndRepairAllFiles": string;
        "Ui.Settings.Hatch.VerifyAndRepairAllFilesDesc": string;
        "Ui.Settings.Maintenance.Cleanup": string;
        "Ui.Settings.Maintenance.CleanupDesc": string;
        "Ui.Settings.Maintenance.DeleteLocalDatabase": string;
        "Ui.Settings.Maintenance.EmergencyRestart": string;
        "Ui.Settings.Maintenance.EmergencyRestartDesc": string;
        "Ui.Settings.Maintenance.FreshStartWipe": string;
        "Ui.Settings.Maintenance.FreshStartWipeDesc": string;
        "Ui.Settings.Maintenance.GarbageCollection": string;
        "Ui.Settings.Maintenance.GarbageCollectionAction": string;
        "Ui.Settings.Maintenance.GarbageCollectionDesc": string;
        "Ui.Settings.Maintenance.LockServer": string;
        "Ui.Settings.Maintenance.LockServerDesc": string;
        "Ui.Settings.Maintenance.OverwriteRemote": string;
        "Ui.Settings.Maintenance.OverwriteRemoteDesc": string;
        "Ui.Settings.Maintenance.OverwriteServerData": string;
        "Ui.Settings.Maintenance.OverwriteServerDataDesc": string;
        "Ui.Settings.Maintenance.PurgeAllJournalCounter": string;
        "Ui.Settings.Maintenance.PurgeAllJournalCounterDesc": string;
        "Ui.Settings.Maintenance.RebuildingOperations": string;
        "Ui.Settings.Maintenance.Resend": string;
        "Ui.Settings.Maintenance.ResendDesc": string;
        "Ui.Settings.Maintenance.Reset": string;
        "Ui.Settings.Maintenance.ResetAllJournalCounter": string;
        "Ui.Settings.Maintenance.ResetAllJournalCounterDesc": string;
        "Ui.Settings.Maintenance.ResetJournalReceived": string;
        "Ui.Settings.Maintenance.ResetJournalReceivedDesc": string;
        "Ui.Settings.Maintenance.ResetJournalSent": string;
        "Ui.Settings.Maintenance.ResetJournalSentDesc": string;
        "Ui.Settings.Maintenance.ResetLocalSyncInfo": string;
        "Ui.Settings.Maintenance.ResetLocalSyncInfoDesc": string;
        "Ui.Settings.Maintenance.ResetReceived": string;
        "Ui.Settings.Maintenance.ResetSentHistory": string;
        "Ui.Settings.Maintenance.ResetThisDevice": string;
        "Ui.Settings.Maintenance.ScheduleAndRestart": string;
        "Ui.Settings.Maintenance.Scram": string;
        "Ui.Settings.Maintenance.SendChunks": string;
        "Ui.Settings.Maintenance.Syncing": string;
        "Ui.Settings.Maintenance.WarningLockedReadyAction": string;
        "Ui.Settings.Maintenance.WarningLockedReadyText": string;
        "Ui.Settings.Maintenance.WarningLockedResolveAction": string;
        "Ui.Settings.Maintenance.WarningLockedResolveText": string;
        "Ui.Settings.Maintenance.WriteRedFlagAndRestart": string;
        "Ui.Settings.Patches.CompatibilityConflict": string;
        "Ui.Settings.Patches.CompatibilityDatabase": string;
        "Ui.Settings.Patches.CompatibilityInternalApi": string;
        "Ui.Settings.Patches.CompatibilityMetadata": string;
        "Ui.Settings.Patches.CompatibilityRemote": string;
        "Ui.Settings.Patches.CompatibilityTrouble": string;
        "Ui.Settings.Patches.CurrentAdapter": string;
        "Ui.Settings.Patches.DatabaseAdapter": string;
        "Ui.Settings.Patches.DatabaseAdapterDesc": string;
        "Ui.Settings.Patches.EdgeCaseBehaviour": string;
        "Ui.Settings.Patches.EdgeCaseDatabase": string;
        "Ui.Settings.Patches.EdgeCaseProcessing": string;
        "Ui.Settings.Patches.IndexedDbWarning": string;
        "Ui.Settings.Patches.MigratingToIdb": string;
        "Ui.Settings.Patches.MigratingToIndexedDb": string;
        "Ui.Settings.Patches.MigrationIdbCompleted": string;
        "Ui.Settings.Patches.MigrationIdbCompletedFollowUp": string;
        "Ui.Settings.Patches.MigrationIndexedDbCompleted": string;
        "Ui.Settings.Patches.MigrationIndexedDbCompletedFollowUp": string;
        "Ui.Settings.Patches.MigrationWarning": string;
        "Ui.Settings.Patches.OperationToIdb": string;
        "Ui.Settings.Patches.OperationToIndexedDb": string;
        "Ui.Settings.Patches.Remediation": string;
        "Ui.Settings.Patches.RemediationChanged": string;
        "Ui.Settings.Patches.RemediationNoLimit": string;
        "Ui.Settings.Patches.RemediationRestarting": string;
        "Ui.Settings.Patches.RemediationRestartLater": string;
        "Ui.Settings.Patches.RemediationRestartMessage": string;
        "Ui.Settings.Patches.RemediationRestartNow": string;
        "Ui.Settings.Patches.RemediationSuffixChanged": string;
        "Ui.Settings.Patches.RemediationWithValue": string;
        "Ui.Settings.Patches.RemoteDatabaseSunset": string;
        "Ui.Settings.Patches.SwitchToIDB": string;
        "Ui.Settings.Patches.SwitchToIndexedDb": string;
        "Ui.Settings.PowerUsers.ConfigurationEncryption": string;
        "Ui.Settings.PowerUsers.ConnectionTweak": string;
        "Ui.Settings.PowerUsers.ConnectionTweakDesc": string;
        "Ui.Settings.PowerUsers.Default": string;
        "Ui.Settings.PowerUsers.Developer": string;
        "Ui.Settings.PowerUsers.EncryptSensitiveConfig": string;
        "Ui.Settings.PowerUsers.PromptPassphraseEveryLaunch": string;
        "Ui.Settings.PowerUsers.UseCustomPassphrase": string;
        "Ui.Settings.Remote.Activate": string;
        "Ui.Settings.Remote.ActiveSuffix": string;
        "Ui.Settings.Remote.AddConnection": string;
        "Ui.Settings.Remote.AddRemoteDefaultName": string;
        "Ui.Settings.Remote.ConfigureAndChangeRemote": string;
        "Ui.Settings.Remote.ConfigureE2EE": string;
        "Ui.Settings.Remote.ConfigureRemote": string;
        "Ui.Settings.Remote.DeleteRemoteConfirm": string;
        "Ui.Settings.Remote.DeleteRemoteTitle": string;
        "Ui.Settings.Remote.DisplayName": string;
        "Ui.Settings.Remote.DuplicateRemote": string;
        "Ui.Settings.Remote.DuplicateRemoteSuffix": string;
        "Ui.Settings.Remote.E2EEConfiguration": string;
        "Ui.Settings.Remote.Export": string;
        "Ui.Settings.Remote.FetchRemoteSettings": string;
        "Ui.Settings.Remote.ImportConnection": string;
        "Ui.Settings.Remote.ImportConnectionPrompt": string;
        "Ui.Settings.Remote.ImportedCouchDb": string;
        "Ui.Settings.Remote.ImportedRemote": string;
        "Ui.Settings.Remote.MoreActions": string;
        "Ui.Settings.Remote.PeerToPeerPanel": string;
        "Ui.Settings.Remote.RemoteConfigurationPrefix": string;
        "Ui.Settings.Remote.RemoteDatabases": string;
        "Ui.Settings.Remote.RemoteName": string;
        "Ui.Settings.Remote.RemoteNameCouchDb": string;
        "Ui.Settings.Remote.RemoteNameP2P": string;
        "Ui.Settings.Remote.RemoteNameS3": string;
        "Ui.Settings.Remote.Rename": string;
        "Ui.Settings.Selector.AddDefaultPatterns": string;
        "Ui.Settings.Selector.CrossPlatform": string;
        "Ui.Settings.Selector.Default": string;
        "Ui.Settings.Selector.HiddenFiles": string;
        "Ui.Settings.Selector.IgnorePatterns": string;
        "Ui.Settings.Selector.NonSynchronisingFiles": string;
        "Ui.Settings.Selector.NonSynchronisingFilesDesc": string;
        "Ui.Settings.Selector.NormalFiles": string;
        "Ui.Settings.Selector.OverwritePatterns": string;
        "Ui.Settings.Selector.OverwritePatternsDesc": string;
        "Ui.Settings.Selector.SynchronisingFiles": string;
        "Ui.Settings.Selector.SynchronisingFilesDesc": string;
        "Ui.Settings.Selector.TargetPatterns": string;
        "Ui.Settings.Selector.TargetPatternsDesc": string;
        "Ui.Settings.Setup.RerunWizardButton": string;
        "Ui.Settings.Setup.RerunWizardDesc": string;
        "Ui.Settings.Setup.RerunWizardName": string;
        "Ui.Settings.SyncSettings.Fetch": string;
        "Ui.Settings.SyncSettings.Merge": string;
        "Ui.Settings.SyncSettings.Overwrite": string;
        "Ui.SetupWizard.Common.Back": string;
        "Ui.SetupWizard.Common.Cancel": string;
        "Ui.SetupWizard.Common.ProceedSelectOption": string;
        "Ui.SetupWizard.Intro.ExistingOption": string;
        "Ui.SetupWizard.Intro.ExistingOptionDesc": string;
        "Ui.SetupWizard.Intro.Guidance": string;
        "Ui.SetupWizard.Intro.NewOption": string;
        "Ui.SetupWizard.Intro.NewOptionDesc": string;
        "Ui.SetupWizard.Intro.ProceedExisting": string;
        "Ui.SetupWizard.Intro.ProceedNew": string;
        "Ui.SetupWizard.Intro.Question": string;
        "Ui.SetupWizard.Intro.Title": string;
        "Ui.SetupWizard.OutroAskUserMode.CompatibleOption": string;
        "Ui.SetupWizard.OutroAskUserMode.CompatibleOptionDesc": string;
        "Ui.SetupWizard.OutroAskUserMode.ExistingOption": string;
        "Ui.SetupWizard.OutroAskUserMode.ExistingOptionDesc": string;
        "Ui.SetupWizard.OutroAskUserMode.Guidance": string;
        "Ui.SetupWizard.OutroAskUserMode.NewOption": string;
        "Ui.SetupWizard.OutroAskUserMode.NewOptionDesc": string;
        "Ui.SetupWizard.OutroAskUserMode.ProceedApplySettings": string;
        "Ui.SetupWizard.OutroAskUserMode.ProceedNext": string;
        "Ui.SetupWizard.OutroAskUserMode.Question": string;
        "Ui.SetupWizard.OutroAskUserMode.Title": string;
        "Ui.SetupWizard.OutroNewUser.GuidancePrimary": string;
        "Ui.SetupWizard.OutroNewUser.GuidanceWarning": string;
        "Ui.SetupWizard.OutroNewUser.Important": string;
        "Ui.SetupWizard.OutroNewUser.Proceed": string;
        "Ui.SetupWizard.OutroNewUser.Question": string;
        "Ui.SetupWizard.OutroNewUser.Title": string;
        "Ui.SetupWizard.SelectExisting.Guidance": string;
        "Ui.SetupWizard.SelectExisting.ManualOption": string;
        "Ui.SetupWizard.SelectExisting.ManualOptionDesc": string;
        "Ui.SetupWizard.SelectExisting.ProceedManual": string;
        "Ui.SetupWizard.SelectExisting.ProceedQr": string;
        "Ui.SetupWizard.SelectExisting.ProceedSetupUri": string;
        "Ui.SetupWizard.SelectExisting.QrOption": string;
        "Ui.SetupWizard.SelectExisting.QrOptionDesc": string;
        "Ui.SetupWizard.SelectExisting.Question": string;
        "Ui.SetupWizard.SelectExisting.SetupUriOption": string;
        "Ui.SetupWizard.SelectExisting.SetupUriOptionDesc": string;
        "Ui.SetupWizard.SelectExisting.Title": string;
        "Ui.SetupWizard.SelectNew.Guidance": string;
        "Ui.SetupWizard.SelectNew.ManualOption": string;
        "Ui.SetupWizard.SelectNew.ManualOptionDesc": string;
        "Ui.SetupWizard.SelectNew.ProceedManual": string;
        "Ui.SetupWizard.SelectNew.ProceedSetupUri": string;
        "Ui.SetupWizard.SelectNew.Question": string;
        "Ui.SetupWizard.SelectNew.SetupUriOption": string;
        "Ui.SetupWizard.SelectNew.SetupUriOptionDesc": string;
        "Ui.SetupWizard.SelectNew.Title": string;
        "Ui.SetupWizard.SetupRemote.BucketOption": string;
        "Ui.SetupWizard.SetupRemote.BucketOptionDesc": string;
        "Ui.SetupWizard.SetupRemote.CouchDbOptionDesc": string;
        "Ui.SetupWizard.SetupRemote.Guidance": string;
        "Ui.SetupWizard.SetupRemote.P2POption": string;
        "Ui.SetupWizard.SetupRemote.P2POptionDesc": string;
        "Ui.SetupWizard.SetupRemote.ProceedBucket": string;
        "Ui.SetupWizard.SetupRemote.ProceedCouchDb": string;
        "Ui.SetupWizard.SetupRemote.ProceedP2P": string;
        "Ui.SetupWizard.SetupRemote.Title": string;
        ...
        "Use JWT instead of Basic Authentication": string;
        "Use Only Local Chunks": string;
